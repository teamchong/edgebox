...
const math_polyfill = @import("polyfills/math.zig");
...
// Import frozen_init_c from frozen_functions.c (generated by edgebox-freeze)
...
pub fn main() !void {
    ...
    math_polyfill.register(ctx); // Replace QuickJS Math with native Zig Math
